...
array1=[
   ...
   [True,str({"labels": {"asn": "62", "net1_address": "10.62.0.0/24", "neighbors":[7,100] }},),str({"labels": {"asn": "62", "net1_address": "10.62.0.0/24", "neighbors":[]}})],
...
def compile():
   with open('routingdb2.json', 'w', newline='') as fileout:
